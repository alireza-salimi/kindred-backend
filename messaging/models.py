...
class Message(models.Model):
    ...
    sent_from = models.ForeignKey(
        'kindred.KindredMember', on_delete=models.CASCADE, related_name='sent_messages', verbose_name=_('Sent from')
    )
    sent_to = models.ForeignKey(
        'kindred.KindredMember', on_delete=models.CASCADE, related_name='received_messages', verbose_name=_('Sent to')
    )
